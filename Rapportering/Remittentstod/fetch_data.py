...
def get_modality_data_for_year(year: int, modality: str) -> pd.DataFrame:
    ...
    rembox.filter_options.patient_size_in_centimeters_include_nulls = modality in (MODALITY_MG, MODALITY_DX)
    rembox.filter_options.patient_weight_in_kilograms_include_nulls = modality in (MODALITY_MG, MODALITY_DX)
