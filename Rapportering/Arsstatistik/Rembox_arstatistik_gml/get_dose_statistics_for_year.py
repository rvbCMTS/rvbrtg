from Rapportering.Arsstatistik.Rembox_arstatistik_gml.src.get import *
from Rapportering.Arsstatistik.Rembox_arstatistik_gml.src.save_as import *


def get_gml_dose_statistics_for_year(year: int = -9999):
    '''
...
if __name__ == '__main__':
    get_gml_dose_statistics_for_year(year=2022)
