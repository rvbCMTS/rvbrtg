...
EXAM_GROUPING_RULES_BY_MODALITY = {
    ...
    MODALITY_DX: {
        EXAM_GROUPING_TYPE_STUDY_DESCRIPTION: {
            ...
            "RTG04:Konventionella röntgenutrustningar (fast installerad):Diagnostik:Bäcken höfter": ['Bäcken', 'Protesbäcken', 'Höftleder, barn', 'Höft stereo DX', 'Höft stereo SIN', 'Höftled DX', 'Höftled SIN', "Sacroiliacaleder"],
            "RTG05:Konventionella röntgenutrustningar (fast installerad):Diagnostik:Extremitetsskelett,  inklusive axlar/axelled": ['Axel, AC-led DX', 'Axel, AC-led SIN', 'Armbågsled DX', 'Armbågsled SIN',
                                                                                                                                    'Benlängd', 'Benvinkel DX', 'Benvinkel SIN', 'Fot DX', 'Fot SIN',
                                                                                                                                    ...
                                                                                                                                    'Lårben', 'Scaphoideum DX', 'Scaphoideum SIN', 'Skelettålder',
                                                                                                                                    'Underarm DX', 'Underarm SIN', 'Underben DX', 'Underben SIN', 'Överarm DX', 'Överarm SIN'],
            "RTG06:Konventionella röntgenutrustningar (fast installerad):Diagnostik:Ryggraden": ["Bröstryggrad", 'Halsrygg', 'Helrygg', 'Ländrygg', "Sacrum, coccyx"],
            "RTG07:Konventionella röntgenutrustningar (fast installerad):Diagnostik:Övrig diagnostik": [],
            "MOB1:Mobil röntgenutrustning för bildtagning:Diagnostik:Thorax inkl lunga/hjärta, Bröstkorg": ['Lungor', 'Lungor, liggande', "Sternum"],
            "MOB2:Mobil röntgenutrustning för bildtagning:Diagnostik:Extremiteter, inklusive axlar/axelled": ['Axel, AC-led DX', 'Axel, AC-led SIN', 'Armbågsled DX', 'Armbågsled SIN', 'Benlängd', 'Benvinkel DX', 'Benvinkel SIN',
                                                                                                             'Fot DX', 'Fot SIN', 'Fot belastad DX', 'Fot belastad SIN', 'Fotled DX', 'Fotled SIN',
                                                                                                             'Fotled belastad DX', 'Fotled belastad SIN', 'Hand DX', 'Hand SIN', 'Handled DX', 'Handled SIN',
                                                                                                             'Knäled DX', 'Knäled SIN', 'Knäled', 'Lårben DX', 'Lårben SIN', 'Lårben', 'Scaphoideum DX', 'Scaphoideum SIN',
                                                                                                             'Skelettålder', 'Underarm DX', 'Underarm SIN', 'Underben DX', 'Underben SIN', 'Överarm DX', 'Överarm SIN'],
