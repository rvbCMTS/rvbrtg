...
CALCULATION_SITES: list[CalculationSite] = [
    ...
    CalculationSite(site="Dorotea_side", datum="2024-11-28", images_per_year=3000, distance_tube_to_barrier=np.sqrt(17.5)/2),
    CalculationSite(site="Dorotea_out", datum="2024-11-28", images_per_year=3000, distance_tube_to_barrier=np.sqrt(17.5)/2 + np.sqrt(7.8)),
]
